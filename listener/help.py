...
def create_help():
    ...
    embed.add_field(
        name=f"2. `{COMMAND_PREFIX}길드 길드명` 또는 `{COMMAND_PREFIX}guild 길드명`",
    ...
    embed.add_field(
        name=f"3. `{COMMAND_PREFIX}썬데이` 또는 `{COMMAND_PREFIX}선데이` 또는 `{COMMAND_PREFIX}sun`",
    ...
    embed.add_field(
        name=f"4. `{COMMAND_PREFIX}부티크 개수(1 ~ 10,000,000)`",
        value=(
